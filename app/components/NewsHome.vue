          ...
          <div class="news-one__left">
            ...
            <div class="news-one__bottom">
              <ul class="list-unstyled news-one__meta">
                ...
                <li><span>/</span></li>
                <li>
                  <a href="#">{{ featuredPost.commentCount }} Comments</a>
                </li>
              </ul>
            ...
            >
              ...
              <div class="news-one__right-content">
                ...
                <h3 class="news-one__right-title">
                  <nuxt-link :to="post.url" v-html="post.title"></nuxt-link>
                </h3>
              </div>
            </div>
          </div>
...
import { blogHome } from "~/data/content"

const secContent = blogHome.sectionTitle
const featuredPost = blogHome.posts[0]!
const posts = blogHome.posts.slice(1, 4)
</script>
